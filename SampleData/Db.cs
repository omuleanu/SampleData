...
namespace Omu.SampleData
{
    public static class Db
    {
        ...
        public static T Insert<T>(T o) where T : Entity
        {
            ...
            throw new SampleDbException("can not add new item");
        }
        ...
        public static T Get<T>(int id) where T : Entity
        {
            ...
            if (entity == null || entity.IsDeleted) throw new SampleDbException("this item doesn't exist anymore");
            return entity;
        }
